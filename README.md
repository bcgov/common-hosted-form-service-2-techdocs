...
# Common Hosted Forms Service 2 - Technical Documentation

Technical documentation repository to be hosted in Backstage.
The main code repo these techdocs refer to is: [https://github.com/bcgov/soba](https://github.com/bcgov/soba)  
